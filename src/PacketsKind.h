...
enum SCHEDULE_STATE {
    ...
    SELF_MSKIND_DISTR_3P_REQUEST,
    SELF_MSKIND_DISTR_3P_RECEIVE,
...
enum APP_PACKET_KIND {
    ...
    APP_SYNC_REPLY,
    APP_SYNC_RETURN,
    APP_DISTR_3P_REQUEST,
    APP_DISTR_3P_RESPONSE,
    APP_DISTR_DIRECTION_REQUEST,
    APP_DISTR_DIRECTION_RESPONSE
};
